...
{
    private readonly FileBaseContextQueryableMethodTranslatingExpressionVisitor _queryableMethodTranslatingExpressionVisitor;
    private readonly FileBaseContextExpressionTranslatingExpressionVisitor _expressionTranslatingExpressionVisitor;
    ...
    public FileBaseContextProjectionBindingExpressionVisitor(
        FileBaseContextQueryableMethodTranslatingExpressionVisitor queryableMethodTranslatingExpressionVisitor,
        FileBaseContextExpressionTranslatingExpressionVisitor expressionTranslatingExpressionVisitor)
    {
    ...
    public virtual Expression Translate(FileBaseContextQueryExpression queryExpression, Expression expression)
    {
            ...
            if (_indexBasedBinding)
            {
                switch (expression)
                {
                    ...
                    case ProjectionBindingExpression projectionBindingExpression:
                        ...
                        if (mappedProjection is not FileBaseContextQueryExpression)
                        {
        ...
        if (extensionExpression is StructuralTypeShaperExpression entityShaperExpression)
        {
            ...
            if (entityShaperExpression.ValueBufferExpression is ProjectionBindingExpression projectionBindingExpression)
            {
                entityProjectionExpression =
                    (EntityProjectionExpression)((FileBaseContextQueryExpression)projectionBindingExpression.QueryExpression)
