    ...
    : DbContextTestClassBase<CsvSerializationTests.CsvTestDbContext>
{
    ...
    public void CanSaveByteArrays()
    {
        ...
        string content = ReadFileContext(GetDatabaseFullFileName(nameof(EntityHasByteArray) + ".csv"));
    ...
    public void CanDeserializeByteArraysFromCsv()
    {
        ...
        string content = ReadFileContext(GetDatabaseFullFileName("EntityHasByteArray.csv"));
