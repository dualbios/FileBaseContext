    ...
    : DbContextTestClassBase<CsvSerializationWithConvertersTests.CsvTestDbContext>
{
    ...
    public void CanRoundTripValueConverterToString_NonEmpty()
    {
        ...
        //string content = ReadFileContext(GetDatabaseFullFileName(nameof(EntityUsesStringValueConverter)));
    ...
    public void CanRoundTripValueConverterToBytes_Empty()
    {
        ...
        string content = ReadFileContext(GetDatabaseFullFileName(nameof(EntityUsesBytesValueConverter) + ".csv"));
