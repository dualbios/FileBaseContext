    ...
    : DbContextTestClassBase<CsvDbTestContext>
{
    ...
    public void ReadFromFile()
    {
        ...
        //assert
        string content = ReadFileContext(GetDatabaseFullFileName(nameof(User) + ".csv"));
    ...
    public void WriteToFile()
    {
        ...
        AssertString(@"Id,CreatedOn,Name,Test,Test2,Type,UpdatedOn,Username" + Environment.NewLine +
                     @"1,01/01/2000 11:12:13,john_doe,,e4030155-ef22-4954-9b7c-c9ee398a8086,User,,john_doe_name" + Environment.NewLine,
                     fileContent);
    }
    ...
    public static void AssertString(string expected, string actual)
    {
        if(expected==null || actual==null)
            Assert.Fail("Expected and/or Actoal string is null.");
